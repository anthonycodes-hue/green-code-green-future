...
export const ideas: Idea[] = [
  ...
  },
  {
    ...
    problem:
      "Standard map apps optimize for speed, ignoring the carbon cost of every trip and the toll on our air quality.",
    solution:
      "A routing app that surfaces walking, cycling, and transit options and shows the CO₂ you saved. Great for learning maps APIs.",
    features: [
